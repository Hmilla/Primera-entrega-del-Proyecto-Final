...
const { productosContenedor } = require('./ControllerProductos')

 
const carts = new Contenedor()
...
const deleteCarrito = async (req, res) => {
    ...
    if(!isNumber(id)){
        return res.json({ error: "El parámetro no es un número o el id no es correcto" })
    }
...
const deleteProductoCarrito = async (req, res)=>{
    ...
    res.json(await carts.deleteProductCartById(id,id_prod))  
}
